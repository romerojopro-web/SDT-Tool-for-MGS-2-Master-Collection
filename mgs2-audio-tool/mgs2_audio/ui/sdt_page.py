...
class SDTPage(QWidget):
    ...
    def __init__(self, window):
        ...
        self._want_play = False   # playback requested while waiting for the media
    ...
    @property
    def db_folder(self):
        """The tagging database folder is shared with the SDX tab."""
    ...
    def pick_db_folder(self):
        ...
        self.win.sdx_page.reload_library()
